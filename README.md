...
## ⚙️ 2. Công cụ Google Apps Script (GAS)

* **[Auto Send Email](./GAS/AutoEmail.gs):** Script tự động gửi mail báo cáo từ Google Sheet.
* **[Format Sheet](./GAS/FormatSheet.gs):** Tự động căn chỉnh màu sắc bảng tính.

---

> 💡 **Mẹo:** Nhấn phím **`T`** trên bàn phím để mở ô tìm kiếm file nhanh trong Repo này.
